...
| 'destructive' | 'info' | 'teal' | 'amber' | 'grey';
...
export default function Quotes2ListPage() {
      ...
      <div className="shrink-0 border-b border-border/40">
        <div className="flex items-center gap-2 px-4 pt-4 pb-3">
          <div className="flex-1 min-w-0">
            <h1 className="text-2xl font-semibold tracking-tight leading-tight">Quotes 2</h1>
            <p className="text-sm text-muted-foreground mt-0.5">Layout exploration — new quote detail experience.</p>
          </div>
              ...
              {paged.map((rfq, idx) => {
                ...
                return (
                  <div
                    ...
                    onClick={() => router.push(`/rfq2/explore/${rfq.rfqId}`)}
                  >
